...
- **Still to write: a referral piece** (clients introducing people to Guy - the referral rate went live 14 Sep, after the series was locked). Slot: after i-know-a-guy-principle. Source: the referral doctrine drafts. Must also carry a New Leads pointer: an introduced person often arrives first as a name on a call, and New Leads is how they get into the system.
- **Feature pointers (Guy, 2026-09-25):** each client email gets at most one line pointing to the portal screen that does what it teaches (Follow-Ups in #14 and New Leads in #11 done; the rest go in during the one-by-one review). A screen never gets a whole email of its own - the series is ideas; how-to lives in Wingguy Learning.
