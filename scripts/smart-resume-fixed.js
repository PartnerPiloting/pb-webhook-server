...
async function main() {
    ...
    try {
        ...
        await JobTracking.createJobRun(normalizedRunId, stream);
    ...
    try {
        ...
        for (let i = 0; i < clientsNeedingWork.length; i++) {
            ...
            try {
                ...
                await JobTracking.createClientRun(normalizedRunId, workflow.clientId, workflow.clientName);
            ...
            try {
                ...
                await JobTracking.completeClientRun(normalizedRunId, workflow.clientId, success, notes);
        ...
        try {
            ...
            await JobTracking.updateAggregateMetrics({ 
            ...
            await JobTracking.completeJobRun(normalizedRunId, true, notes);
        ...
        try {
            ...
            await JobTracking.completeJobRun(normalizedRunId, false, notes);
