@echo off
REM Kill any process on port 3010, clear .next, start Next on 3010
for /f "tokens=5" %%a in ('netstat -ano ^| findstr :3010 ^| findstr LISTENING') do set PID=%%a
if defined PID (
  echo Killing PID %PID% on 3010...
