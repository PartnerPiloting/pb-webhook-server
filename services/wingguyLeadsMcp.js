...
const TOOL_DEFS = [
  ...
  },
  {
    ...
    zodSchema: {
      ...
      linkedin_url: z.string().optional().describe('The lead\'s LinkedIn profile URL (linkedin.com/in/...) - the strongest lookup key.'),
      add_tags: z.union([z.array(z.string()), z.string()]).optional().describe('Tags to put ON the record, as PLAIN comma-separated text - unsubscribed, referral. No brackets, no quote marks: whatever punctuation you wrap it in becomes part of the tag.'),
      remove_tags: z.union([z.array(z.string()), z.string()]).optional().describe('Tags to take OFF the record, as PLAIN comma-separated text - mindset mastery, newsletter. No brackets, no quote marks. Case doesn\'t matter.'),
    ...
    jsonSchema: {
      ...
      properties: {
        ...
        linkedin_url: { type: 'string', description: 'The lead\'s LinkedIn profile URL (linkedin.com/in/...) - the strongest lookup key.' },
        add_tags: { anyOf: [{ type: 'array', items: { type: 'string' } }, { type: 'string' }], description: 'Tags to put ON the record, as PLAIN comma-separated text - unsubscribed, referral. No brackets, no quote marks: whatever punctuation you wrap it in becomes part of the tag.' },
        remove_tags: { anyOf: [{ type: 'array', items: { type: 'string' } }, { type: 'string' }], description: 'Tags to take OFF the record, as PLAIN comma-separated text - mindset mastery, newsletter. No brackets, no quote marks. Case doesn\'t matter.' },
