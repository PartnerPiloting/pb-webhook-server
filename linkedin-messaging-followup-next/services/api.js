...
console.log("í´ DEBUG - Environment variable NEXT_PUBLIC_API_BASE_URL:", process.env.NEXT_PUBLIC_API_BASE_URL);
console.log("í´ DEBUG - Fallback URL would be:", "https://pb-webhook-server-hotfix.onrender.com/api/linkedin");
const API_BASE_URL = process.env.NEXT_PUBLIC_API_BASE_URL || 'https://pb-webhook-server-hotfix.onrender.com/api/linkedin';
console.log("í´ DEBUG - Final API_BASE_URL being used:", API_BASE_URL);
