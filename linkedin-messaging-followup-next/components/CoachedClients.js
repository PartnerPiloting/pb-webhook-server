      ...
      <div className="bg-slate-50 border border-slate-200 rounded-lg p-4 grid grid-cols-1 md:grid-cols-2 gap-5">
        <div className="flex flex-col gap-3">
          ...
          <div className="flex gap-2 pt-1 flex-wrap">
            <button onClick={() => router.push(buildAuthUrl(`/coached-clients/${card.clientId}/concierge`))} className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-blue-200 bg-blue-50 text-blue-700 text-sm font-medium hover:bg-blue-100" title="The run sheet for doing the whole setup yourself over remote access - every link minted, in order">
