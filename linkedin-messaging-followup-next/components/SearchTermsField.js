...
// - placeholder?: string
// - disabled?: boolean
// - showBooleanHelp?: boolean (show boolean search syntax help, default true for search page)
export default function SearchTermsField({ initialTerms, onTermsChange, placeholder = 'Type terms and press Enter or comma. Supports: AND, OR, NOT, ( ), "exact phrase"', disabled = false, showBooleanHelp = true }) {
  ...
  return (
    <div className="flex-1">
      {/* Boolean search help hint - only show on search page */}
      {showBooleanHelp && (
