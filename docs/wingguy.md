...
- **REVISED STAGED PLAN:**
  ...
  - **Stage 2 — Fix the 3 shared leaks (affect BOTH surfaces):** booking-prefs returns Guy's Zoom/LinkedIn/phone regardless of client ([wingguyBookingPrefs.js:54](../config/wingguyBookingPrefs.js)); in-chat rules-door writes to Guy's rulebook ([wingguyChat.js:427](../services/wingguyChat.js)); owner-gate 403s non-Guy ([wingguyRoutes.js:42](../routes/wingguyRoutes.js)). Guy's values stay the DEFAULT so nothing of his changes.
