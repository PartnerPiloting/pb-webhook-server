...
1. ✅ **RESOLVED (2026-07-01) — not a conflict, it's TWO CAMPAIGNS.** `\frac` (keyword "fractional") + `\tks` (general default) = the extension's existing routing. Canonical wording = Guy's AI Blaze paste in Notion, unchanged (`\frac` = the "Winning Formula" block on "03 — Conversations & Messaging"; `\tks` = "The Prompt Behind the Magic"). **Verified the extension mirrors BOTH word-for-word — no drift.** (The "ASH / two-way collaboration" I flagged was the general campaign's underlying philosophy, not a rival vocabulary.) Minor tidy-ups: (a) the `\tks` template's in-line signature "Talk soon / I know a (Guy)" vs today's voice-prefs house sign-off "(I know a) Guy"; (b) the Master Brief manifest points to a non-existent "LinkedIn Templates" page.
