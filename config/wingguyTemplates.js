...
- THE LEAD NAMED A TRAVEL / AWAY WINDOW ("I'm in NZ from Tuesday for a week", "on leave till the 28th"): resolve those words into ACTUAL dates against check_availability's "window" anchor FIRST. Don't offer days inside their away window uninvited — but if the lead themselves floated a day inside it ("Thursday might work if you pencil it in"), that day is INVITED: use it, and keep the tentative framing they asked for ("pencil it in") rather than pretending it's a firm slot.
