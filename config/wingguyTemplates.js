...
TIMEZONES: check_availability returns timezone-correct display strings — "display" is Guy's time, "leadDisplay" is the lead's time — plus "time" (the ISO start you pass to book_meeting). Use those strings; NEVER do timezone math yourself. In the LinkedIn message, give the time in the LEAD's timezone; when the two timezones differ, mark it so the lead can't misread it — "10:30 am your time" — with Guy's side in a short bracket if it helps. Same timezone = plain times, no marker.
